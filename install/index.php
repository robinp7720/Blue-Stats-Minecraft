			   		...
			   		<div class="row">
			   			...
			   			<div class="col-md-6">
			   				<div class="input-group">
								...
								<input type="text" class="form-control" placeholder="Username" name="bs-username" value="minecraft">
							</div>
			   			</div>
			   		</div>
			   		<div class="row">
			   			...
			   			<div class="col-md-6">
			   				<div class="input-group">
								...
								<input type="text" class="form-control" placeholder="DataBase" name="bs-db" value="BlueStats">
							</div>
			   			</div>
				   </div>
				</div>
